...
```{r echo = FALSE, fig.cap="Botões gustativos presentes na superfície lateral das papilas circunvaladas. Observe a região do poro gustativo, as células gustativas, as células sustentaculares e a região de sinapse com neurônios sensitivos.", fig.align='default'}
knitr::include_graphics("images/neuro-gust.jpeg", error = FALSE)
```
