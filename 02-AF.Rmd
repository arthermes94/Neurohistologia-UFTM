...
```{r echo = FALSE, fig.cap="Pericário de um neurônio pseudounipolar sensitivo localizado no gânglio da raiz dorsal de um nervo espinal. Observe as células satélites fornecendo sustentação para esse neurônio.", fig.align='default'}
knitr::include_graphics("images/neuro-celssatelite.jpeg", error = FALSE)
```
...
```{r echo = FALSE, fig.cap="Um pequeno gânglio autonômico situado em meio ao tecido conjuntivo das trabéculas da glândula submandibular.", fig.align='default'}
knitr::include_graphics("images/neuro-ganglio.jpeg", error = FALSE)
```
