...
```{r echo = FALSE, fig.cap="Prolongamentos neuronais observados em corte histológico corado pela prata.", fig.align='default'}
knitr::include_graphics("images/neuro-prata.jpeg", error = FALSE)
```
