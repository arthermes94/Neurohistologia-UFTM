...
```{r echo = FALSE, fig.cap="Imagem de um feixe vásculo-nervoso.", fig.align='default'}
knitr::include_graphics("images/neuro-feixeneurovasc.jpeg", error = FALSE)
```

```{r echo = FALSE, fig.cap="Componente neural de um feixe neurovascular.", fig.align='default'}
knitr::include_graphics("images/neuro-feixevascner.jpeg", error = FALSE)
```
...
```{r echo = FALSE, fig.cap="Aspecto de um nervo periférico à microscopia de luz.", fig.align='default'}
knitr::include_graphics("images/neuro-nervo.jpeg", error = FALSE)
```
