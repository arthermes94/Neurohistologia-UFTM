...
```{r echo = FALSE, fig.cap="Corte histológico da região cortical do cérebro (corado pela prata).", fig.align='default'}
knitr::include_graphics("images/neuro-cortex.jpeg", error = FALSE)
```
